...
export default function Login() {
  ...
  const loginPatient = async e => {
    ...
    const data = await login(dispatch, patientData);
    if (data === 401) {
                    ...
                    <div className='col-md-9 col-lg-8 mx-auto'>
                      ...
                      <form>
                        ...
                        <div className='d-grid'>
                          <button className='btn btn-lg btn-success btn-login text-uppercase fw-bold mb-2' type='submit' onClick={loginPatient}>
                            Sign in
                          </button>
